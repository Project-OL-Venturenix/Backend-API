...
public class UserTestCase {
  ...
  public UserTestCase(Event event, User user, Group group, Question question, TestCase testcase, String testcase_pass_status, Double run_time_by_sec, String status, LocalDateTime createddate, Integer createdby, LocalDateTime updateddate, Integer updatedby) {
    this.event = event;
    this.user = user;
    this.group = group;
  ...
  @Override
  public boolean equals(Object utc) {
      if (this == utc) return true;
      if (utc == null || getClass() != utc.getClass()) return false;
      UserTestCase usertestcase = (UserTestCase) utc;
      return Objects.equals(id, usertestcase.id);
  }
