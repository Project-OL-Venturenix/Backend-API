...
public class UserScore {
  ...
  public UserScore(Event event, User user, Group group, Question question, Integer testcase_total, Integer testcase_pass_total, Double testcase_score_total, String status, LocalDateTime createddate, Integer createdby, LocalDateTime updateddate, Integer updatedby) {
    this.event = event;
    this.user = user;
    this.group = group;
  ...
  public boolean equals(Object us) {
      ...
      if (us == null || getClass() != us.getClass()) return false;
      UserScore userscore = (UserScore) us;
